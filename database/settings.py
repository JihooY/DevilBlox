...
LEGACY_SETTING_MAP = {
    ...
    "ticket_state_log": ("channels", "ticket_state_log"),
    "stock_condition": ("channels", "stock_condition"),
    "stock_control": ("channels", "stock_control"),
    ...
    "stock_condition_msg": ("meta", "stock_condition_message_id"),
    "stock_control_msg": ("meta", "stock_control_message_id"),
...
def default_settings(guild_id: int) -> dict:
    return {
        ...
        "meta": {
            ...
            "stock_condition_message_id": None,
            "stock_condition_reset_at": None,
            "stock_control_message_id": None,
